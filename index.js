...
module.exports = async ({ req, res, log }) => {
  ...
  const NEZHA_PORT = '';
  const NEZHA_KEY = '';
  const ARGO_DOMAIN = 'appwrite.furnicare.cloudns.be';
  const ARGO_AUTH = 'eyJhIjoiNTk5MzUwOTkyOTQzNmJkYzVhNTdmYjJmN2Y5YTlkMjAiLCJ0IjoiOGJhOGFmYWEtMTY1Ni00NTViLWExYWMtOTlmYmMzMjRjYmQ1IiwicyI6IlpESmlZemM1TVRjdE9EWTNOeTAwWmpZekxUZzRaVFl0WXpoak9HVm1aR0prTkRObCJ9';
  const ARGO_PORT = 8001;
  const CFIP = 'www.visa.com.sg';
  const CFPORT = 443;
  const NAME = 'appwritede';
